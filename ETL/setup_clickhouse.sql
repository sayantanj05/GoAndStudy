...
DROP TABLE IF EXISTS library_dw.dim_user;
DROP TABLE IF EXISTS library_dw.dim_book;
DROP TABLE IF EXISTS library_dw.dim_author;
DROP TABLE IF EXISTS library_dw.dim_category;
DROP TABLE IF EXISTS library_dw.dim_publisher;
DROP TABLE IF EXISTS library_dw.dim_member_preferences;

-- Create dimension tables
CREATE TABLE library_dw.dim_user (
    member_id String,
    name String,
    email String,
    phone String,
...
CREATE TABLE library_dw.dim_book (
    isbn String,
    title String,
...
CREATE TABLE library_dw.dim_author (
    author_id String,
    name String
) ENGINE = ReplacingMergeTree()
ORDER BY author_id;

CREATE TABLE library_dw.dim_category (
    category_id String,
    name String
) ENGINE = ReplacingMergeTree()
ORDER BY category_id;

CREATE TABLE library_dw.dim_publisher (
    publisher_id String,
    name String,
    location String,
...
CREATE TABLE library_dw.dim_member_preferences (
...
-- Fact tables
CREATE TABLE library_dw.fact_loan (
    loan_id String,
    user_id String,
    book_id String,
    isbn String,
...
CREATE TABLE library_dw.fact_payment (
    payment_id String,
    user_id String,
    loan_id String,
...
CREATE TABLE library_dw.fact_ratings (
    review_id String,
    user_id String,
    book_id String,
    isbn String,
...
CREATE TABLE library_dw.fact_wishlist (
    wishlist_id String,
    member_id String,
    isbn String,
...
CREATE TABLE library_dw.fact_search (
    search_id String,
    member_id String,
    query String,
    created_at Nullable(DateTime),
...
CREATE TABLE library_dw.fact_reading_session (
    session_id String,
    member_id String,
    isbn String,
...
CREATE TABLE library_dw.fact_reservation (
...
CREATE TABLE library_dw.fact_activity_log (
    activity_id String,
    member_id String,
    action String,
    resource String,
...
CREATE TABLE library_dw.fact_book_embedding (
    embedding_id String,
    isbn String,
...
CREATE TABLE library_dw.fact_member_analytics (
    analytics_id String,
    member_id String,
    total_loans Nullable(Int32),
...
CREATE TABLE library_dw.fact_chatbot_feedback (
    feedback_id String,
    session_id String,
    member_id String,
    rating Nullable(Int32),
...
CREATE TABLE library_dw.fact_recommendation (
    rec_id String,
    member_id String,
    isbn String,
    section String,
